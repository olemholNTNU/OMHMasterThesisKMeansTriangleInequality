...
// Compare-Means Modified
int findClosestCenter(Point centers[], long* centerdistances, Point newPoint) {
...
//				points[currentAmountOfPoints++] = newPoint;
				...
				points[currentAmountOfPoints++].center = findClosestCenter(centers, centerDistances, newPoint);
